  ...
  return (
    <div id="guide_page" className="bg-white px-6 py-10 sm:py-20 lg:px-8 flex-grow">
      <div className="mx-auto max-w-3xl text-base/7 text-gray-700">
        <p className="text-base/7 font-raleway font-semibold text-blue-600">Grow</p>
        <h1 className="mt-2 text-pretty text-4xl font-raleway font-semibold tracking-tight text-gray-900 sm:text-5xl">
          Cultivation Guides
        </h1>
        <p className="mt-6 text-xl/8">
          There is a vast corpus of videos, blog posts, and forum threads on the Internet about growing mushrooms.
          This makes it difficult for beginners to know where to start and steepens the already steep learning curve
          of cultivation. Mycomize cultivation guides are designed to flatten that curve by providing concise yet
          complete instruction for each step of the growing process.
        </p>
        <div className="mt-6 text-lg max-w-2xl">
          <ul role="list" className="mt-6 pl-12 space-y-8 text-gray-600">
            <li className="flex gap-x-3">
              <p><span className="font-bold">&#x2702; Cut through the noise</span> with concise, step-by-step instruction</p>
            </li>
            <li className="flex gap-x-3">
              <p><span className="font-bold">&#x23f3; Save time</span> following proven methods</p>
            </li>
            <li className="flex gap-x-3">
              <p><span className="font-bold">&#x1f6d2; Start growing immediately</span> with a comprehensive shopping list</p>
            </li>
          </ul>
        </div>
