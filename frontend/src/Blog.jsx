        ...
        <div id="blog_page" className="bg-white px-6 py-10 sm:py-20 lg:px-8 flex-grow">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              <div className="mx-auto max-w-2xl">
                ...
                <p className="mt-4 text-lg/8 text-gray-600">Learn about the latest in mushroom cultivation and psychedelic science</p>
                <div className="mt-8 space-y-16 border-t border-gray-400 pt-8 sm:mt-16 sm:pt-16">
                  {posts.map((post) => (
                    <article key={post.id} className="flex max-w-xl flex-col items-start justify-between">
                      ...
                      <div className="relative mt-8 flex items-center gap-x-4">
                        <img alt="" src={post.author.imageUrl} className="circle object-cover w-12 h-12 sm:w-14 sm:h-14 bg-gray-50" />
